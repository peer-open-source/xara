...
/** @file BS_thread_pool.hpp @author Barak Shoshany (baraksh@gmail.com)
 * (http://baraksh.com) @version 4.0.1 @date 2023-12-28 @copyright Copyright
 * (c) 2023 Barak Shoshany. Licensed under the MIT license. If you found this
 * project useful, please consider starring it on GitHub! If you use this
 * library in software of any kind, please provide a link to the GitHub
 * repository https://github.com/bshoshany/thread-pool in the source code and
 * documentation.
 *
 * If you use this library in published research, please cite it
 * as follows: Barak Shoshany, "A C++17 Thread Pool for High-Performance
 ...
 * additional classes and definitions. No other files are needed in order to
 * use the thread pool itself.
 */
...
namespace this_thread {
    ...
    {
        friend class OpenSees::thread_pool;

...
int 
GenericClient::getNumExternalNodes() const
{
...
const ID& 
GenericClient::getExternalNodes()
{
...
void 
GenericClient::setDomain(Domain *theDomain)
{
...
int 
GenericClient::addLoad(ElementalLoad *theLoad, double loadFactor)
{

...
#ifndef LeadRubberY_h
#define LeadRubberY_h
...
class LeadRubberY : public Element
{
public:
    // Constructor
    LeadRubberY(int eleTag, int Nd1, int Nd2, double qd, double alpha, double Gr, double Kbulk,
    ...
    const char *getClassType() const {return "LeadRubberY";};

...
WheelRail::setDomain(Domain *thePassedDomain)
{
	...
	if (theDomain != nullptr)
	  this->Element::link(*theDomain);//����Ϣ����domain
...
WheelRail::update(void)
{
	...
	const Vector &disp1 = theNodes[0]->getTrialDisp();//�ֽڵ��λ��
	const Vector &disp2 = theNodes[activeBeamIndex+1]->getTrialDisp();//�������ڵ�λ��
	const Vector &disp3 = theNodes[activeBeamIndex+2]->getTrialDisp();//�������ڵ�λ��
	...
	if(Fhz>0){
		...
		double dDeltadFH = 2*G*pow(Fhz,-1/3.0)/3.0;//ע������ʱ����getUfDeltaU��������
...
WheelRail::setResponse(const char **argv, int argc, OPS_Stream &output)
{
  ...
  /*/ ��¼�Ӵ���
      Ƕ������1����uF��1���� Fhz��1���� theDeltaY��1���� uUnderWheel��3����//*/
...
//===========================
	...
	if (i>maxIterT)	opserr<<maxIterT<<"�ε�����ʧ�ܣ�";//previous process*/ 
//========================================
	/*
	...
	if (i>=maxIterT)	opserr<<maxIterT<<"�ε�����ʧ�ܣ�";//revised on2018/9/4 by Yongdou Liu/*/

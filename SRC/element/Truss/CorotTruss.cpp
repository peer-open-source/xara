...
CorotTruss::setDomain(Domain* theDomain)
{
  ...
  if ((theNodes[0] == 0) || (theNodes[1] == 0)) {
    opserr << "CorotTruss::setDomain() - CorotTruss " << this->getTag() << " node " << Nd1
...
{
  opserr << "CorotTruss::addLoad - load type unknown for truss with tag: " << this->getTag()
         << endln;
...
CorotTruss::setResponse(const char** argv, int argc, OPS_Stream& output)
{
  ...
  if ((strcmp(argv[0], "force") == 0) || (strcmp(argv[0], "forces") == 0) ||
    ...
    theResponse = new ElementResponse(this, 1, Vector(numDOF));
             ...
             (strcmp(argv[0], "localForces") == 0) || (strcmp(argv[0], "basicForces") == 0)) {
...
CorotTruss::getResponse(int responseID, Information& eleInfo)
{
  ...
  case 2: return eleInfo.setDouble(A * theMaterial->getStress());

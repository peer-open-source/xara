...
int
CorotTrussSection::getNumExternalNodes() const
{
  return 2;
}

const ID&
CorotTrussSection::getExternalNodes()
{
...
Node**
CorotTrussSection::getNodePtrs()
{
  return theNodes;
}

int
CorotTrussSection::getNumDOF()
{
  return numDOF;
}
...
{
  opserr << "CorotTrussSection::addLoad - load type unknown for truss with tag: " << this->getTag()
         << endln;
  return -1;
}
...
double
CorotTrussSection::computeCurrentStrain()
{

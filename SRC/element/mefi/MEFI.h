...
//
// Reference:
// 1.- L�pez, C. N., Rojas, F., & Massone, L. M. (2022). Membrane fiber element for reinforced concrete walls � the benefits of macro and micro modeling approaches. Engineering Structures, 254, 113819.
//

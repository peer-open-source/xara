...
ElasticMembranePlateSection::ElasticMembranePlateSection(int tag,
 ...
 : SectionForceDeformation(tag, SEC_TAG_ElasticMembranePlateSection), strain(8)
{
...
ElasticMembranePlateSection::getCopy()
{
  ...
  clone = new ElasticMembranePlateSection(this->getTag(), Em, nu, h, rhoH,
                                          Ep / Em); //new instance of this class
...
int
ElasticMembranePlateSection::recvSelf(int cTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
  int res = 0;
  static Vector data(6);

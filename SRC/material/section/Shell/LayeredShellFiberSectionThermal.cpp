...
Response*
LayeredShellFiberSectionThermal::setResponse(const char** argv, int argc, OPS_Stream& output)
{
...
int
LayeredShellFiberSectionThermal ::setTrialSectionDeformation(
...
LayeredShellFiberSectionThermal::sendSelf(int commitTag, Channel& theChannel)
{
  ...
  if (res < 0) {
    opserr << "WARNING LayeredShellFiberSectionThermal::sendSelf() - " << this->getTag()
...
int
LayeredShellFiberSectionThermal::recvSelf(int commitTag, Channel& theChannel,
                                          FEM_ObjectBroker& theBroker)
{
  ...
  if (res < 0) {
    opserr << "WARNING LayeredShellFiberSectionThermal::recvSelf() - " << this->getTag()
  ...
  if (nLayers > 0) {
    ...
    for (i = 0; i < nLayers; i++) {
      ...
      if (res < 0) {
        opserr << "LayeredShellFiberSectionThermal::recvSelf() - material " << i
               << ", failed to recv itself" << endln;
        return res;
      }
    }
  }

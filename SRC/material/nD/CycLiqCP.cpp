...
CycLiqCP::plastic_integrator()
{
  ...
  // trace of strain
  double trace = strain_nplus1(0,0) + strain_nplus1(1,1) + strain_nplus1(2,2) ;
  //trace of strain from previous step
  double trace_n = strain_n(0,0) + strain_n(1,1) + strain_n(2,2) ;
...
double
CycLiqCP::doublecontraction(Matrix a, Matrix b)
{
	int i,j;
...
Matrix
CycLiqCP::doublecontraction42(double b[][3][3][3], Matrix a)
{
	Matrix Da(3,3) ;
	Da.Zero();
  for (int i =0; i<3; i++) {
...
//double contraction of 4 and 2 order tensors
Matrix
CycLiqCP::doublecontraction24(Matrix a, double b[][3][3][3])
{
	Matrix aD(3,3) ;
	aD.Zero();
  for (int i =0; i<3; i++) {
...
void
CycLiqCP::index_map(int matrix_index, int &i, int &j )
{

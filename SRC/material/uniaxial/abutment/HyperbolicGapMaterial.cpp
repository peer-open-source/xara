...
HyperbolicGapMaterial::HyperbolicGapMaterial(int tag, 
                                             double kmax, 
                                             double kur, 
                                             double rf, 
                                             double fult, 
...
UniaxialMaterial *
HyperbolicGapMaterial::getCopy()
{
  HyperbolicGapMaterial *theCopy = new HyperbolicGapMaterial(
                                        this->getTag(),
                                        Kmax,Kur,Rf,Fult,gap,density);
...
double 
HyperbolicGapMaterial::getStrain()
{
  return Tstrain;
}

double 
HyperbolicGapMaterial::getStress()
{
  return Tstress;
}

double 
HyperbolicGapMaterial::getTangent()
{
  return Ttangent;
}

double 
HyperbolicGapMaterial::getInitialTangent()
{
  return Kmax; 
}
...
int 
HyperbolicGapMaterial::commitState()
{
...
int 
HyperbolicGapMaterial::revertToLastCommit()
{
...
int 
HyperbolicGapMaterial::revertToStart()
{
  Cstrain = 0.0;
  Cstress = 0.0;
  Tstrain = 0.0;

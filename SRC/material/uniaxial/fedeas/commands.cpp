                                  ...
                                  int argc, TCL_Char ** const argv)
{
  ...
  if (strcmp(argv[1], "Hardening1") == 0 ||
    ...
    if (Tcl_GetDouble(interp, argv[3], &u1p) != TCL_OK) {
      opserr << "WARNING invalid u1p" << OpenSees::SignalMessageEnd;
      return 0;
    }
    ...
    if (Tcl_GetDouble(interp, argv[5], &fpcu) != TCL_OK) {
      opserr << "WARNING invalid fpcu" << OpenSees::SignalMessageEnd;
      return 0;
    }
    if (Tcl_GetDouble(interp, argv[6], &epscu) != TCL_OK) {
    ...
    if (Tcl_GetDouble(interp, argv[7], &rat) != TCL_OK) {
      opserr << "WARNING invalid rat" << OpenSees::SignalMessageEnd;
      return 0;
    }
    if (Tcl_GetDouble(interp, argv[8], &ft) != TCL_OK) {
      opserr << "WARNING invalid ft" << OpenSees::SignalMessageEnd;
      return 0;
    }
    if (Tcl_GetDouble(interp, argv[9], &epst0) != TCL_OK) {
      opserr << "WARNING invalid epst0" << OpenSees::SignalMessageEnd;
      return 0;
    }
    if (Tcl_GetDouble(interp, argv[10], &ft0) != TCL_OK) {
      opserr << "WARNING invalid ft0" << OpenSees::SignalMessageEnd;
      return 0;
    }
    ...
    if (Tcl_GetDouble(interp, argv[12], &epstu) != TCL_OK) {
      opserr << "WARNING invalid epstu" << OpenSees::SignalMessageEnd;
      return 0;
    }

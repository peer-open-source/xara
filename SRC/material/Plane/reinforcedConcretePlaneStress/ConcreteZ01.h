...
public:
  ...
  int setTrialStrain(double x, double k, double Dfactor, double ITAP, double EPSLONTP,
                     double strain, double strainRate = 0.0);
  ...
  double getZeta(void);
  double getPD(
      void); // Get partial differentiation of stress to epslonTP (strain in perpendicular direction)

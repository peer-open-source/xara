...
public:
  TendonL01(int tag, double fy, double E0, double fpu, double rou, double epsp,
            double ac = TENDON_01_DEFAULT_AC, double rc = TENDON_01_DEFAULT_RC);
  TendonL01();
  ~TendonL01();
...
private:
  ...
  double
      CreverseTopStrain[SIZE1]; // array storing the strain and stress of top point of reverse loop
  double CreverseTopStress[SIZE1];
  double CreverseBottomStrain
      [SIZE1]; // array storing the strain and stress of last point of reverse loop
  ...
  double
      TreverseTopStrain[SIZE1]; // array storing the strain and stress of top point of reverse loop

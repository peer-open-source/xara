...
// w
//================================================================================
double LogWEnergy::wE(const double &J_in, const Vector &lambda_wave_in)
  {
...
// d(vol)w / dJ
//================================================================================
double LogWEnergy::dvolwOdJ(const double &J_in)
{
//   printf("J=%lf\n",J_in);
...
// d2(vol)w / dJ2
//================================================================================
double LogWEnergy::d2volwOdJ2(const double &J_in)
{
//   printf("J=%lf\n",J_in);

...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
BJMaterial * NeoHookeanCompressible3D::getCopyBJ (void)
{
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
BJMaterial * NeoHookeanCompressible3D::getCopyBJ (const char *type)
{
   opserr << "NeoHookeanCompressible3D::getCopyBJ(const char *) - not yet implemented\n";
   return 0;
}

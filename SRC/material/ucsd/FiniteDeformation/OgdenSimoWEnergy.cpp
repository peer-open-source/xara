...
// w
//================================================================================
double  OgdenSimoWEnergy::wE(const double &J_in, const Vector &lambda_wave_in )
  {
    double wEnergy = 0.0;
...
// d(vol)w / dJ
//================================================================================
double  OgdenSimoWEnergy::dvolwOdJ(const double &J_in )
{
...
// d2(vol)w / dJ2
//================================================================================
double  OgdenSimoWEnergy::d2volwOdJ2(const double &J_in )
{

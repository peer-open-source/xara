...
//================================================================================
WEnergy * MooneyRivlinSimoWEnergy::copy()
  {
...
// w
//================================================================================
double MooneyRivlinSimoWEnergy::wE(const double &J_in, const Vector &lambda_wave_in)
  {
...
// d(vol)w / dJ
//================================================================================
double  MooneyRivlinSimoWEnergy::dvolwOdJ(const double &J_in )
{
...
// d2(vol)w / dJ2
//================================================================================
double  MooneyRivlinSimoWEnergy::d2volwOdJ2(const double &J_in )
{

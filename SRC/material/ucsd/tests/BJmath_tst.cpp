...
//====
  ...
  //  t2.print("t2x2","\ntensor t2 x 2.0");
    ...
    BJtensor t2xt2 = t2("ij")*t2("jk");
    t2xt2.print("t2xt2","\ntensor t2 x t2");

    BJtensor t2xtst = t2("ij")*tst("jk");
    t2xtst.print("t2xtst","\ntensor t2 x tst");
    ...
    static double Tvalues[] = {   1,2,3,
                                  4,5,6,
                                  7,8,9  };
#if defined(BJTENSOR_DO_MULT_TEST)
    BJtensor multTest( 2, def_dim_2, t2values);

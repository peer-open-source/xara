...
int 
BeamFiberMaterial::getOrder() const
{
  return 3;
}

const char*
BeamFiberMaterial::getType() const 
{
  return "BeamFiber";
}

int 
BeamFiberMaterial::commitState()
{
  Cstrain22 = Tstrain22;
  Cstrain33 = Tstrain33;
  Cgamma23 = Tgamma23;
...
int 
BeamFiberMaterial::revertToLastCommit()
{
  Tstrain22 = Cstrain22;
  Tstrain33 = Cstrain33;
  Tgamma23 = Cgamma23;
...
BeamFiberMaterial::setTrialStrain(const Vector &strainFromElement)
{
  ...
  do {
    ...
    threeDstrain(2) = this->Tstrain33; // zz
    threeDstrain(3) = this->strain(1); // xy
